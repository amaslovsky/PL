...
/**
 * Sign-up screen. Calls `AuthContext.signup`; on success the BE sets
 * the JWT cookie and the SPA navigates home. Passwords must be at
 * least 8 chars; the BE re-validates.
 */
