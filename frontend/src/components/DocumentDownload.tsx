...
import { NdaPdfDocument } from "@/components/NdaPdf";
 ...
 * server round-trip. Today this is MNDA-only; other templates will get
 * their own `NdaPdfDocument`-style renderer.
 */
export function DocumentDownload({ data, onBeforeDownload }: DocumentDownloadProps) {
